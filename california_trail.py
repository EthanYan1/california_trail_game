...
ScreenList = {"home_screen": {"img_path": "ImageAssets\\HomeScreen\\home_screen_trail.png", "map_path" :  "ImageAssets\\HomeScreen\\map_california_trail_homescreen.png", "prompt": ["You, a glory-seeking American from Missouri, are ready to pack up your peaceful", "and chase a life of adventure and riches in California! But not everything", "is bliss, as you will need to choose carefully how you get there,", "through the California Trail.", "", "The California Trail was used to reach gold mines and fertile farmland, and was", "mainly used by gold miners and farmers between 1841 and 1869.", "Many men traveled either with a mule, on horseback, or getting pulled in a wagon", "by a mule, horse, or oxen. Today, you'll get to travel on it!", "Press Play to continue."],\
