...
ScreenList = {"home_screen": {"img_path": "california_trail_project\\ImageAssets\\HomeScreen\\home_screen_trail.png", "map_path" :  "california_trail_project\\ImageAssets\\HomeScreen\\map_california_trail_homescreen.png", "prompt": ["You, a glory-seeking American from Missouri, are ready to pack up your peaceful", "and chase a life of adventure and riches in California! But not everything", "is bliss, as you will need to choose carefully how you get there,", "through the California Trail... Press Play to continue."],\
                              "option1":[None, None], "option2" : [None, None], "option3" : ["Play", "screen_entertrail"], "option4" : [None, None]},\
              "screen_entertrail": {"img_path" : "california_trail_project\\ImageAssets\\enter_scene\\california_trail_enter.png", "map_path" : "california_trail_project\\ImageAssets\\enter_scene\\map_california_trail_enterscene.png", "prompt": ["You have entered the California trail. Which way do you travel?", "There seems to be only one way."],\
"option1":[None,None], "option2":[None,None], "option3":["Straight", "screen_vastplain"], "option4":[None,None]},\
              "screen_vastplain":{"img_path":"california_trail_project\\ImageAssets\\vast_plain_scene\\vast_plain_trail.png", "map_path":"california_trail_project\\ImageAssets\\vast_plain_scene\\map_california_trail_vastplain.png", "prompt": ["You find yourself in a vast plain. Though bare, it provides an indicator of the California trail.", "In the distance is a ginormous rock that would give a view of where you are going.", "Do you head towards it?"], \
                                  "option1":[None,None], "option2":["Yes", "screen_bigrock"], "option3":["No", "screen_wolfdeath"], "option4":[None,None]},\
              "screen_wolfdeath":{"img_path":"california_trail_project\\ImageAssets\\wolf_death\\wolf.png", "map_path":"california_trail_project\\ImageAssets\\wolf_death\\map_california_trail_wolfdeath.png", "prompt":["You head the other direction in the plain. Suddenly, you hear a growling", "behind you, and turn around to face a wolf. The wolf isn't so friendly, and", "it mauls you to death."],\
                                  "option1":[None,None], "option2":[None, None], "option3":["Try again from start", "home_screen"], "option4":[None,None]},\
              "screen_bigrock":{"img_path":"california_trail_project\\ImageAssets\\big_rock_scene\\giant_rock.png", "map_path":"california_trail_project\\ImageAssets\\big_rock_scene\\map_california_trail_giant_rock.png", "prompt": ["You traverse the barren landscape, and come to the foot of the rock. After hours of climbing,", "you reach the peak, and overlook the whole of the plains. A speck of unnatural white", "in the golden grass catches your eye."],\
